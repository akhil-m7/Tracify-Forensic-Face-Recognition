...
public class DashboardController implements Initializable {
    ...
    public void save_img(){
            ...
            //Directory 
            fileChooser.setInitialDirectory(new File("C:\\Users\\Temp\\OneDrive\\Desktop\\project\\Project Code (forensic face sketch)\\TRACIFY\\src\\thirdeye\\v2\\elements\\output"));
   ...
   @FXML
private Button backButton; // Must match the fx:id in Dashboard.fxml

@FXML
private void goBackToMenu() {
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/thirdeye/v2/menu.fxml")); // Adjust path if needed
